...
# Set up paths
downloads_path = r"C:\Users\Costas\Downloads"
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(log_file, encoding="utf-8"),  # Ensures UTF-8 support
...
# Output the total number of files moved and end script
logging.info(f"Total files moved: {files_moved}")

logging.info("✅ Script execution completed. Exiting now.")
exit(0)  # Ensures the script terminates
